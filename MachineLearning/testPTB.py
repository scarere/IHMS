...
df = pd.read_csv('heartbeat-data/ptb-100hz/ptb-100hz-v2-filt_abnormal.csv', header=None)
df2 = pd.read_csv('heartbeat-data/ptb-100hz/ptb-100hz-v2-filt_normal.csv', header=None)
...
print('\n 0s - Loading Model ... \n')
ts = time.time()
model = load_model('models/ptb-100hz-filt.h5')
tc = time.time() - ts
