...
df = pd.read_csv('heartbeat-data/ptb-60hz/ptb-60hz-v2_abnormal.csv', header=None)
df2 = pd.read_csv('heartbeat-data/ptb-60hz/ptb-60hz-v2_normal.csv', header=None)
...
print('\n 0s - Loading Model ... \n')
ts = time.time()
model = load_model('models/ptb-60hz.h5')
tc = time.time() - ts
