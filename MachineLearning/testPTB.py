...
df = pd.read_csv('heartbeat-data/ptb-400hz-v2/ptb-400hz_abnormal-v2.csv', header=None)
df2 = pd.read_csv('heartbeat-data/ptb-400hz-v2/ptb-400hz_normal-v2.csv', header=None)
...
print('\n 0s - Loading Model ... \n')
ts = time.time()
model = load_model('models/ptb-400hz-v2.h5')
tc = time.time() - ts
